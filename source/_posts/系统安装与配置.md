...
笔记分四类整理：
文字类使用[印象笔记](https://www.yinxiang.com/products/)整理，
代码类使用[Github](https://github.com/)整理，
本地编辑`MarkDown`文档采用[Typora](https://typora.io/)，
数学类使用[LATEX](https://www.latex-project.org/get/)整理，
富媒体使用PowerPoint管理，并同步于Onedrive。
